	...
	<div class="row">
		<div class="col-md-12">
			<ul class="nav nav-pills flex-column flex-md-row mb-4">
				<li class="nav-item">
					<a class="nav-link active" href="{{ route('admin.user.detail',$user->id) }}"><i class="ti-xs ti ti-users me-1"></i> Profile Details</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="{{ route('admin.user.documents',$user->id) }}"><i class="ti-xs ti ti-lock me-1"></i> Documents</a>
				</li>
				<li class="nav-item">
			...
			<div class="card mb-4">
				...
				<hr class="my-0" />
				<div class="card-body">
					<form action="{{ route('admin.user.detail.update',$user->id) }}" method="POST">
					@csrf
						<div class="row">
